...
exports.PORTAL_DEFAULT_FIELDS = exports.runPortal = exports.createPortalDataSource = exports.PortalDataSourceBuilder = void 0;
...
const runPortal = async (squidProcessor) => {
    ...
    const builder = (0, exports.createPortalDataSource)(config, { fields });
    ...
    new typeorm_store_1.TypeormDatabase({
        stateSchema,
