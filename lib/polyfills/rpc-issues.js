...
const logRPCCall = (method, duration, cuCost) => {
...
rpc_client_1.RpcClient.prototype.call = async function (method, params, options) {
    ...
    processing_stats_1.processingStats.totalCUCost += cuCost;
    ...
    processing_stats_1.processingStats.rpcCUCosts.set(method, (processing_stats_1.processingStats.rpcCUCosts.get(method) ?? 0) + cuCost);
...
rpc_client_1.RpcClient.prototype.batchCall = async function (batch, options) {
    ...
    processing_stats_1.processingStats.totalCUCost += batchCUCost;
