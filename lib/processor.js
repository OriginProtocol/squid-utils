...
exports.run = exports.chainConfigs = exports.joinProcessors = exports.defineProcessor = exports.defineSquidProcessor = exports.setupEvmBatchProcessor = void 0;
...
const setupEvmBatchProcessor = (evmBatchProcessor, config, options) => {
...
exports.setupEvmBatchProcessor = setupEvmBatchProcessor;
...
exports.chainConfigs = {
    ...
    [chains_1.plumeMainnet.id]: {
        chain: chains_1.plumeMainnet,
...
const run = async (evmBatchProcessor, { fromNow, chainId = 1, stateSchema, processors, postProcessors, validators, postValidation }) => {
    if (!fromNow) {
    ...
    (0, exports.setupEvmBatchProcessor)(evmBatchProcessor, config);
